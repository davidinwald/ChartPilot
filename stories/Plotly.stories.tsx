...
export const Docs: Story = {
  name: "Docs",
  render: () => <div>Plotly documentation and usage tips go here.</div>,
};
...
export const TimeSeries: StoryObj<BaseChartArgs> = {
  ...
  render: (args) => {
    ...
    try {
      ...
      const { data, layout } = configs[0].config;

      layout.showlegend = args.showLegend;
      layout.paper_bgcolor = args.theme === "dark" ? "#333" : "#fff";
      layout.plot_bgcolor = args.theme === "dark" ? "#333" : "#fff";
      layout.xaxis = { ...layout.xaxis, showgrid: args.showGrid };
      layout.yaxis = { ...layout.yaxis, showgrid: args.showGrid };
...
export const ScatterPlot: StoryObj<BaseChartArgs & { pointSize: number }> = {
  ...
  render: (args) => {
    ...
    try {
      ...
      data[0].marker = { ...data[0].marker, size: args.pointSize };
